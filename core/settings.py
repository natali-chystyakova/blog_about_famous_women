...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PERMISSION_CLASSES": [
        "rest_framework.permissions.AllowAny",  # требовать аутентификацию по умолчанию
    ],
    "DEFAULT_AUTHENTICATION_CLASSES": [
        ...
        "rest_framework.authentication.SessionAuthentication",  # Сессионная аутентификация (по желанию)
        "rest_framework.authentication.BasicAuthentication",  # Базовая аутентификация (по желанию)
    ],
}
